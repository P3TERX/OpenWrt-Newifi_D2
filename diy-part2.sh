...
# Modify default IP
# mod_192.168.1.1_to_192.168.91.1
sed -i 's/192.168.91.1/10.0.0.1/g' package/base-files/files/bin/config_generate

# Modify hostname
sed -i 's/OpenWrt/ixecloud-oob/g' package/base-files/files/bin/config_generate
